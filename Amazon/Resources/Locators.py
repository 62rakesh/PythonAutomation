...
class Locators():
    ...
    Product_detail = (By.LINK_TEXT, "JioFi 4G Hotspot M2S 150 Mbps Jio 4G Portable Wi-Fi Data Device (Black)")
    # Locators of cart page (Tc_3)
    Add_to_cart = (By.ID,"add-to-cart-button")
    Sub_cart_page = (By.ID,"nav-cart")
    # Locators of Checkout page (Tc_4)
    Checkout_page = (By.XPATH,"(//INPUT[@name='proceedToRetailCheckout'])")
